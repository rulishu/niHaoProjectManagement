export const items = (queryInfo, attr) => [{
  label: 'searchTree',
  key: 'searchTree',
  widget: 'searchTree',
  span: '24',
  readSpan: 3,
  widgetProps: {
    allowClear: true // onSearch:(searchValue)=>console.log('SearchTree-> SearchTreeOption',searchValue),
